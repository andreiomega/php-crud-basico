			...
			?>
				<tbody>
					<tr>
						...
						<td>
							<a href="editar-usuario.php?id=<?php echo $id_usuario; ?>" class="btn btn-sm btn-warning" role="button"><i class="fas fa-edit"></i></a>
							<a href="excluir-usuario.php?id=<?php echo $id_usuario; ?>" class="btn btn-sm btn-danger" role="button"><i class="fas fa-trash-alt"></i></a>
						</td>
